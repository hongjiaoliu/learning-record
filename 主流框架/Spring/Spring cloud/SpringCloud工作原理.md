> 引用1 ： [石杉的架构笔记](https://www.jianshu.com/p/c68b9b79aee9)
...
![](image/eureka-schematic-diagram.png)

### 服务网关组件Zuul工作原理

![](image/zuul-schematic-diagram.png)

### 跨域时序图

![](image/Cross-domain-sequence-diagrams.png)

### Eureka与Ribbon整合工作原理

![](image/eureka-ribbon-schematic-diagram.png)
...
![](image/hystrix-schematic-diagram.png)
...
![](image/springboot-auto-config-diagram.png)
