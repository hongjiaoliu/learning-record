...
### 11月9号
+ [听说DNS根服务器只有13台，科学吗](网络/DNS-03/听说DNS根服务器只有13台，科学吗.md)

### 11月8号
+ [DNS中有哪些值得学习的优秀设计](网络/DNS-02/DNS中有哪些值得学习的优秀设计.md)

### 11月7号
+ [刚插上网线，电脑怎么知道自己的IP是什么?](网络/DNS-01/刚插上网线，电脑怎么知道自己的IP是什么.md)
...
+ 复习 ： HashTable和HashMap的区别详解

+ LeetCode 27. 删除元素（Remove Element）

### 7月8号

+ [mybatis你只写了接口为啥就能执行sql啊？](https://www.toutiao.com/a6711153790793286152/?tt_from=weixin&utm_campaign=client_share&wxshare_count=1&timestamp=1562571945&app=news_article&utm_source=weixin&utm_medium=toutiao_ios&req_id=20190708154545010025066213024B551&group_id=6711153790793286152)

+ [java中的动态代理和反射 反向代理](https://blog.csdn.net/familyshizhouna/article/details/78905997)
...
### 3月12号
+ 建立learning-record项目
+ [学习markDown基本语法](未分类/markDown/markDown基础语法.md)
